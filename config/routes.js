...
router.get(    '/videos/:id/collocation_occurrences',                                                validate(pv.collocationOccurrences.index),        passport.authenticate('custom'), isAuthenticated, isAdmin, ctrl.collocationOccurrences.index);
