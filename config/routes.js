...
router.patch(  '/collocation_occurrences/:id',                                                       ValidateParams(pv.collocationOccurrences.update),       Authenticate, AdminOnly, ctrl['collocation-occurrences'].update);
...
router.delete( '/speakers/:id',                                                                      ValidateParams(pv.speakers.delete),                     Authenticate, AdminOnly, ctrl.speakers.delete);
...
router.get(    '/videos/:id/collocation_occurrences',                                                ValidateParams(pv.videos.collocationOccurrences.index), Authenticate, AdminOnly, ctrl.videos.collocationOccurrences.index);
